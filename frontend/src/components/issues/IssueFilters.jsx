import { ArrowDownWideNarrow, CheckCircle2, FolderKanban, Tag } from 'lucide-react';
...
export default function IssueFilters({
  ...
  return (
    <div className="glass-panel grid gap-4 border-white/5 p-4 xl:grid-cols-[1fr_220px_220px_220px] xl:items-end">
