...
export default function PullRequestCharts({ statusData, repositoryData }) {
  ...
  return (
    <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
      <ChartPanel
        ...
        emptyMessage="No pull request status data available."
      >
      ...
      <ChartPanel
        title="Top Repositories By PR Activity"
        icon={BarChart3}
        isEmpty={!repositoryData.length}
        emptyMessage="No repository pull request activity found."
      >
        <ResponsiveContainer width="100%" height="100%">
